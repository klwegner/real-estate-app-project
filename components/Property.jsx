...
const Property = ({property: { _id, name, description, address, imageUrl, propertyType, squareFootage, numBaths, numBeds, price, hasHOA, amenitiesIncluded, inFloodZone}}) => {
...
<Image src={imageUrl ? imageUrl : defaultImage} width="400" height="260" alt="property"/>
    </Box>
    <Box w="full">
